...
function updateScore(player) {
  ...
  //   const data = {
  //     nom: playerName,
  //     temps: totalElapsedTime, // Enregistrer le temps total écoulé
  //     score: scores[player],
  //   };

  //   const xhr = new XMLHttpRequest();
  //   xhr.open("POST", "./data/hightScore.json"); // Remplacez par l'URL de votre fichier JSON
...
//   const formattedTime = formatTime(totalElapsedTime);
//   if (scores[0] === 5) {
//     const userName = prompt(`Player 1 \n WIN in ${formattedTime}!`);
...
// function addScoreToJSONFile(userData) {
//   fetch("http://localhost:4000/highScore.json")
//     .then((response) => {
//       if (!response.ok) {
...
//       // Requête pour mettre à jour le fichier JSON
//       return fetch("http://localhost:4000/highScore.json", {
...
// function getHighScoresFromJSONFile() {
//   return fetch("http://localhost:4000/highScore.json")
//     .then((response) => {
//       if (!response.ok) {
//         throw new Error("Network response was not ok");
...
//         console.log(`${score.nickName}: ${score.time}`);
//       });
//       return highScores; // Retourner les meilleurs scores pour une utilisation ultérieure
//     })
//     .catch((error) => {
