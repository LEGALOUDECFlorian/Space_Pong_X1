...
// };
// const rightPaddle = {
//   x: canvas.width - leftPaddle.x - paddleSize.paddleWidth,
//   y: (canvas.height - paddleSize.paddleHeight) / 2,
//   color: '#4EF349',
// };
...
// //   if (y + moveBall.dy > canvas.height - ballSize.ballRadius || y + moveBall.dy < ballSize.ballRadius) {
...
// //   if (e.key == 'ArrowUp') {
// //     keysPlayers.keysRight.rightUpPressed = true;
// //   } else if (e.key == 'ArrowDown') {
// //     keysPlayers.keysRight.rightDownPressed = true;
...
// //   if (e.key == 'ArrowUp') {
// //     keysPlayers.keysRight.rightUpPressed = false;
// //   } else if (e.key == 'ArrowDown') {
// //     keysPlayers.keysRight.rightDownPressed = false;
// //   }
// // }
...
// //   if (e.key == 'q') {
// //     keysPlayers.keysLeft.leftUpPressed = true;
// //   } else if (e.key == 'w') {
// //     keysPlayers.keysLeft.leftDownPressed = true;
// //   } // Empêche le défilement de la page lors de l'utilisation des touches fléchées
// //   if (e.key === 'q' || e.key === 'w') {
// //     e.preventDefault();
// //   }
...
// //   if (e.key == 'q') {
// //     keysPlayers.keysLeft.leftUpPressed = false;
// //   } else if (e.key == 'w') {
// //     keysPlayers.keysLeft.leftDownPressed = false;
// //   }
// // }
...
//   if (downPressed) {
//     paddle.y += 7;
//     if (paddle.y + paddleSize.paddleHeight > canvas.height) {
//       paddle.y = canvas.height - paddleSize.paddleHeight;
//     }
//   } else if (upPressed) {
//     paddle.y += -7;
//     if (paddle.y < 0) {
...
//   movePaddle(leftPaddle, keysPlayers.keysLeft.leftUpPressed, keysPlayers.keysLeft.leftDownPressed);
//   movePaddle(rightPaddle, keysPlayers.keysRight.rightUpPressed, keysPlayers.keysRight.rightDownPressed);
// }
...
// //     x - ballSize.ballRadius < leftPaddle.x + paddleSize.paddleWidth
// //       && x + ballSize.ballRadius > leftPaddle.x
// //       && y > leftPaddle.y
// //       && y < leftPaddle.y + paddleSize.paddleHeight
// //   ) {
// //     moveBall.dx = -moveBall.dx; // Inverse la direction horizontale
// //     updateSpeedBall(moveBall.dx, moveBall.dy);
// //     console.log(updateSpeedBall(`gauche${moveBall.dx}`, moveBall.dy));
// //     console.log(moveBall.dx);
// //     // console.log(updateSpeedBall());
// //     console.log('gauche 1');
// //     if (
// //       y - ballSize.ballRadius < leftPaddle.y + paddleSize.paddleHeight
// //         && y + ballSize.ballRadius > leftPaddle.y
// //         && x > leftPaddle.x
// //         && x < leftPaddle.x + paddleSize.paddleWidth
// //     ) {
...
//   if (
//     x + ballSize.ballRadius > rightPaddle.x
//       && x - ballSize.ballRadius < rightPaddle.x + paddleSize.paddleWidth
//       && y > rightPaddle.y
//       && y < rightPaddle.y + paddleSize.paddleHeight
//   ) {
//     moveBall.dx = -moveBall.dx; // Inverse la direction horizontale
...
//     if (
//       y + ballSize.ballRadius > rightPaddle.y
//           && y - ballSize.ballRadius < rightPaddle.y + paddleSize.paddleHeight
//           && x > rightPaddle.x
//           && x < rightPaddle.x + paddleSize.paddleWidth
//     ) {
...
//   leftPaddle.x = canvas.width / 6 - paddleSize.paddleHeight;
//   leftPaddle.y = (canvas.height - paddleSize.paddleHeight) / 2;

//   rightPaddle.x = canvas.width - leftPaddle.x - paddleSize.paddleWidth;
//   rightPaddle.y = (canvas.height - paddleSize.paddleHeight) / 2;
// }
...
// function checkScore() {
//   if (x + moveBall.dx < ballSize.ballRadius) {
//     updateScore(1);
//     resetBall();
//     resetPaddles();
//   } else if (x + moveBall.dx > canvas.width - ballSize.ballRadius) {
//     updateScore(0);
//     resetBall();
//     resetPaddles();
//   }
...
// // function drawBall() {
// //   ctx.beginPath();
// //   ctx.arc(x, y, ballSize.ballRadius, 0, Math.PI * 2);
...
// export default interval = setInterval(draw, 10);
